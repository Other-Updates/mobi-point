        ...
        <table class="static" style="display: none;">
            <tr>
                ...
                <!-- <td>
                            ...
                            <select id="mySelect">
                                    <option value="1" class="gst-invoice"  id="checked" name="quotation[bill_category]">GST</option>
                                    <option value="2" class="gst-invoice"   id="unchecked"name="quotation[bill_category]">NOGST</option>
                             </select>
                             </td>
                             <td> -->
                <td>
                    <input type="hidden" id="catname" class="catname" name="catname" value="" />
                    <input type="text" name="model_no[]" id="model_no" style="width:100%;font-weight: 600; " class='form-align auto_customer tabwid model_no required' readonly="" />
                ...
                <td class="action-btn-align">
                    ...
                    <input type="text" name="cost_price[]" style="width:70px;" id="cost_price" class="costing_price perwhole" />
            ...
            <div class="row" id="add_sales">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="customer[tin]" id="tin" tabindex="5" class="form-control form-align " disabled="disabled" />
                ...
                <table class="table  table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    <thead>
                        <tr>
                            ...
                            <!-- <td width="15%" class="first_td1">Type</td> -->
                    ...
                    <tbody id='app_table'>
                        <tr>
                            ...
                            <input type="checkbox" id="box" class="box" name="checkbox" value="" />
                            <select id="mySelect">
                                    <option value="ps">GST</option>
                                    <option value="ab">NOGST</option>
                             </select>
                             </td> -->
                            <td>
                                <input type="hidden" id="catname" class="catname" name="catname" value="" />
...
<script>
    ...
    function profitcalculation() {
        ...
        $('.profit').each(function() {
            ...
            fin_total = fin_total + Number(profit.val());
        });
