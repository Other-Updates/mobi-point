                                ...
                                <tr>
                                    ...
                                    ?>
                                        <td class='action-btn-align'>
                                            <a href="<?php if ($this->user_auth->is_action_allowed('purchase', 'purchase_return', 'view')) : ?><?php echo $this->config->item('base_url') . 'purchase_return/po_views/' . $val['id'] ?><?php endif ?>" data-toggle="tooltip" class="tooltips btn btn-default btn-xs  <?php if (!$this->user_auth->is_action_allowed('purchase', 'purchase_return', 'view')) : ?>alerts<?php endif ?>" title="" data-original-title="View"><?= $val['po_no']; ?></a>
                                        </td>
                                    <?php } else { ?>
