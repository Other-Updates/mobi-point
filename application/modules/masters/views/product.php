                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <span id="branderr" class="val product_mode" style="color:#F00; font-style:oblique;"></span>
                                            <!-- <span class="error_msg"></span> -->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <img id="blah" class="add_staff_thumbnail" width="33px" height="33px" src="<?= $this->config->item("base_url") . 'attachement/product/no-img.gif' ?>" />
                                                </div>
                                                <div class="col-md-10">
    ...
    $(document).ready(function() {
        ...
        $("#submit").on('click', function() {
            ...
            if (brand == "" || brand == null || brand.trim().length == 0) {
                $(".product_mode").html("Required Field");
                m++;
                $('#pname').focus();
            } else {
                $(".product_mode").html("");
