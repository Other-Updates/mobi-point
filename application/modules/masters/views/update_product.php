                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="brand_id" class="form-control form-align mandatory" id="brand" tabindex="1">
                                                        ...
                                                        ?>
                                                                <option hsn="<?php echo $vals['hsn']; ?>" gst="<?php echo $vals['gst']; ?>" value="<?php echo $vals['id']; ?>" <?php echo $select; ?>> <?php echo $vals['brands']; ?> </option>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="col-md-4">
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="radio" name="type" class="" value="product" <?php //if ($val['type'] == 'product') echo 'checked="checked"';
                                                                                                                ?> tabindex="1">Product
                                                    <input type="radio" name="type" class="" value="service"  <?php //if ($val['type'] == 'service') echo 'checked="checked"';
                                                                                                                ?> tabindex="1">Others
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img id="blah" class="add_staff_thumbnail" width="32px" height="32px" src="<?= $this->config->item("base_url") . 'attachement/product/' . $val['product_image']; ?>" />
                                                        </div>
                                                        <div class="col-md-10">
