...
class Product_model extends CI_Model
{
    ...
    var $column_search = array('u.product_name', 'c.categoryName', 'erp_brand.brands', 'u.sales_price', 'u.cost_price'); //set column field database for datatable searchable
    ...
    function _get_datatables_query()
    {
        ...
        $this->db->join($this->erp_brand, 'erp_brand.id=u.brand_id', 'LEFT');
