                            ...
                            ?>
                                    ...
                                    <tr class="tr_<?php echo $vals['product_id']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="ime_code_select">
                                            <?php if($vals['categoryName'] != 'Accessories') { ?>
                                                <div tabindex="0">
                                        ...
                                        <?php if (isset($vals['stock']) && !empty($vals['stock'])) { ?>
                                            ...
                                            <td>
                                                ...
                                                <div class="col-xs-8"> <input <?php echo $vals['categoryName'] != 'Accessories' ? 'readonly' : '';?> type="text" tabindex="6" name='quantity[]' style="width:70px;margin-top: 2px;" class="qty required quantity" exist_qty="<?php echo round($vals['quantity']); ?>" data-stock="<?php echo round($vals['quantity']); ?>" value="<?php echo round($vals['quantity']); ?>" /></div>
