                                          ...
                                          <?php // } */ ?>
                                            <td>
                                                ...
                                                <?php if ($vals['po'][0]['delivery_qty'] == 0) { ?>
                                                    ...
                                                    <input type="text" tabindex="-1" name='return_quantity[]' style="width:70px;margin-top:4px !important;" class="return_qty" readonly="readonly" />
                                                    <span class="error_msg"></span>
                                                <?php } else { ?>
                                                    <span data-toggle="tooltip" class="tooltips btn btn-success btn-xs" style="margin-bottom:4px;margin-top:4px;" title="">Return Quantity</span> &nbsp;
                                                    <input type="text" tabindex="-1" name='return_quantity[]' style="width:70px;margin-top:4px !important;" class="return_qty" />
                                                    <span class="error_msg"></span>
                                                <?php } ?>
                                            </td>
                                            <td>
