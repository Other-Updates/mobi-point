      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <?php if ($this->user_auth->is_module_allowed('masters')): ?>
                             ...
                             <li class="<?php echo ($cur_class == 'manage_category') ? 'active' : ''     ?>" >
                                <a class="key_tab9" href="<?php echo $this->config->item('base_url') . 'masters/manage_category'     ?>"><i class="far fa-circle nav-icon"></i> Manage Category</a>
                            </li> 
                                        <?php endif; ?>
