                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <?php if ($this->user_auth->is_module_allowed('masters')) : ?>
                            <li class="nav-item has-treeview masters_tab1 <?php echo ($cur_class == 'suppliers' || $cur_class == 'manage_category' ||  $cur_class == 'manage_sub_category' || $cur_class == 'customers' || $cur_class == 'firms' || $cur_class == 'user_roles' || $cur_class == 'users' || $cur_class == 'products' || $cur_class == 'categories' || $cur_class == 'brands' || $cur_class == 'reference_groups' || $cur_class == 'email_settings') ? 'menu-open' : '' ?>"><a href="javascript: void(0)" class="nav-link"><i class="fa fa-tachometer-alt fa-fw" aria-hidden="true"></i> Masters <i class="right fas fa-angle-left"></i></a>
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if ($this->user_auth->is_section_allowed('masters', 'categories')) : ?>
                                        <li class="nav-item <?= ($cur_class == 'categories') ? 'active' : '' ?>">
                                            <a class="nav-link key_tab7" href="<?php echo $this->config->item('base_url') . 'masters/categories' ?>"><i class="far fa-circle nav-icon"></i>Product Categories</a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if ($this->user_auth->is_section_allowed('masters', 'brands')) : ?>
                                        <li class="nav-item <?= ($cur_class == 'brands') ? 'active' : '' ?>">
                                            <a class="nav-link key_tab8" href="<?php echo $this->config->item('base_url') . 'masters/brands' ?>"><i class="far fa-circle nav-icon"></i> Product Models</a>
                                        </li>
                                    <?php endif; ?>
                                    <?php  //if ($this->user_auth->is_section_allowed('masters', 'manage_category')):
                                    ?>
                                    <li class=" nav-item<?= ($cur_class == 'manage_category') ? 'active' : ''     ?>">
                                        <a class=" nav-link key_tab9" href="<?php echo $this->config->item('base_url') . 'masters/manage_category'     ?>"><i class="far fa-circle nav-icon"></i> Expense Category</a>
                                    </li>
                                    <?php //endif;
                                    ?>
                                    <?php // if ($this->user_auth->is_section_allowed('masters', 'manage_sub_category')):
                                    ?>
                                    <li class=" nav-item<?= ($cur_class == 'manage_sub_category') ? 'active' : ''     ?>">
                                        <a class=" nav-link key_tab9" href="<?php echo $this->config->item('base_url') . 'masters/manage_sub_category'     ?>"><i class="far fa-circle nav-icon"></i> Expense Sub Category</a>
                                    </li>
                                    <?php //endif;
                                    ?>
                        ...
                        <?php if ($this->user_auth->is_module_allowed('stock')) : ?>
                            <li class="nav-item has-treeview masters_tab4 inventory_tab <?= (($cur_class == 'stock' || $cur_class == 'sku_management' || $cur_class == 'physical_report') && $cur_method == 'index') ? ' menu-open' : '' ?>"><a href="javascript: void(0)" class="nav-link">
                                    <!--<i class="fa fa-suitcase"></i>--> <i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Inventory <i class="right fas fa-angle-left"></i>
                                </a>
                                <ul class="nav nav-treeview">
