        ...
        <table class="static" style="display: none;">
            <tr>
                ...
                <td> <select name='brand[]' tabindex="-1" class='brand_id' style="display:none;">
                    ...
                    <div class="col-xs-8">
                        <input type="text" tabindex="8" name='quantity[]' data-stock="0" exist_qty="0" style="width:70px;" class="qty quantity" id="qty" />
                    </div>
...
<script type="text/javascript">
    ...
    function profitcalculation() {
        ...
        $('.profit').each(function() {
            ...
            // fin_total = fin_total+ $(this).closest('tr').find('.profit').val();
